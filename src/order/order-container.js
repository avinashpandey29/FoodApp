    ...
    if (this.props.summary) {
      return (
        <div className="summary-container">
          ...
          <button variant="contained" className="button default" onClick={this.handleChangeOrder}>
            Select Address
          </button>
        </div>
      )
      ...
      return (
        <div className="order-container">
          ...
          <Button variant="contained" className="button default" color="primary" onClick={this.handleNextCourse}>
